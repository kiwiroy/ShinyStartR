...
This template provides interface information, session information, and a help page to shiny documentation


File structure
--------------

The template generates a [ui.R](https://github.com/PlantandFoodResearch/PFRdataCraft/blob/master/RWorkshops/DataVisualization/Part_2/examples/template1/ui.R) (user interface) [server.R](https://github.com/PlantandFoodResearch/PFRdataCraft/blob/master/RWorkshops/DataVisualization/Part_2/examples/template1/server.R) (server code), and [global.R](https://github.com/PlantandFoodResearch/PFRdataCraft/blob/master/RWorkshops/DataVisualization/Part_2/examples/template1/global.R) (global variables) and an optional [DESCRIPTION](https://github.com/PlantandFoodResearch/PFRdataCraft/blob/master/RWorkshops/DataVisualization/Part_2/examples/template1/DESCRIPTION) file. It also creates a subdirectory called [tests](https://github.com/PlantandFoodResearch/PFRdataCraft/tree/master/RWorkshops/DataVisualization/Part_2/examples/template1/tests) to run a test-suite of tests defined in [tests/testthat](https://github.com/PlantandFoodResearch/PFRdataCraft/tree/master/RWorkshops/DataVisualization/Part_2/examples/template1/tests/testthat).
